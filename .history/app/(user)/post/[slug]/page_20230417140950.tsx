      ...
      <article className=" pb-28 flex flex-col justify-center items-center align-middle mx-auto max-w-3xl ">
        ...
        <section>
          <div>
            ...
            {/* Ignore TS */}
            <PortableText
              className="max-w-xs mx-auto -tracking-tighter  md:-tracking-tight md:max-w-2xl "
              serializers={{
                normal: ({ children }: any) => (
                ...
                h1: ({ children }: any) => (
                  <h1 className="text-2xl md:text-4xl whitespace-nowrap overflow-hidden py-2  font-medium">
                    {children}
                  </h1>
                ),
