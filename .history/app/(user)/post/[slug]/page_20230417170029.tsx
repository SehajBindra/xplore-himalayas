          ...
          <div>
            ...
            <PortableText
              ...
              serializers={{
                ...
                h1: ({ children }: any) => (
                  <h1 className="text-2xl md:text-4xl line-clamp-2 whitespace-nowrap overflow-hidden py-2  font-medium">
                    {children}
                  </h1>
                ),

                h2: ({ children }: any) => (
                  <h2 className="text-xl md:text-3xl line-clamp-2 whitespace-nowrap md:py-4 py-2 font-medium">
                    {children}
                  </h2>
                ),

                h3: ({ children }: any) => (
                  <h3 className="text-lg md:text-text-2xl line-clamp-2 whitespace-normal md:py-4 py-2 font-medium">
                    {children}
                  </h3>
                ),

                h4: ({ children }: any) => (
                  <h4 className="text-md py-2 md:text-xl line-clamp-2 font-medium md:py-8 whitespace-nowrap ">
                    {children}
                  </h4>
                ),
