        ...
        <section>
          <div>
            ...
            <PortableText
              serializers={{
                h1: ({ children }: any) => (
                  <h1 className="text-4xl whitespace-nowrap overflow-hidden py-10 font-medium">
                    {children}
                  </h1>
                ),

                h2: ({ children }: any) => (
                  <h2 className="text-3xl py-10 font-medium">{children}</h2>
                ),

                h3: ({ children }: any) => (
                  <h3 className="text-2xl py-10 font-medium">{children}</h3>
                ),
