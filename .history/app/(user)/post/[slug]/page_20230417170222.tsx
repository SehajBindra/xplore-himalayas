          ...
          <div>
            ...
            <PortableText
              ...
              serializers={{
                ...
                h1: ({ children }: any) => (
                  <h1 className="text-2xl md:text-4xl line-clamp-1  overflow-hidden py-2  font-medium">
                    {children}
                  </h1>
                ),

                h2: ({ children }: any) => (
                  <h2 className="text-xl md:text-3xl line-clamp-1  md:py-4 py-2 font-medium">
                    {children}
                  </h2>
                ),

                h3: ({ children }: any) => (
                  <h3 className="text-lg md:text-text-2xl line-clamp-1  md:py-4 py-2 font-medium">
                    {children}
                  </h3>
                ),
