      ...
      <article className=" pb-28 flex flex-col justify-center items-center align-middle mx-auto max-w-3xl ">
        ...
        <section>
          <div>
            ...
            {/* Ignore TS */}
            <PortableText
              className="max-w-xl px-2 tracking-tight md:max-w-2xl "
              serializers={{
                normal: ({ children }: any) => (
                ...
                bullet: ({ children }: any) => (
                  <ul className="ml-10 text-white/75 py-5 list-disc space-y-5">
                    {children}
                  </ul>
                ),

                number: ({ children }: any) => (
                  <ol className="mt-lg text-white/75 list-decimal">
                    {children}
                  </ol>
                ),
