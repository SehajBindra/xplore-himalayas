        ...
        <section>
          <div>
            <div className=" max-w-xs md:max-w-xl  ">
              <h1 className="text-xl  md:text-3xl text-left text-white  ">
                {post.title}{" "}
              </h1>
            ...
            {/* Ignore TS */}
            <PortableText
              className="max-w-xs mx-auto  -tracking-tight md:max-w-2xl "
              serializers={{
                normal: ({ children }: any) => (
                ...
                h1: ({ children }: any) => (
                  <h1 className="text-2xl md:text-4xl whitespace-nowrap overflow-hidden py-2 md:py-4 font-medium">
                    {children}
                  </h1>
                ),

                h2: ({ children }: any) => (
                  <h2 className="text-xl md:text-3xl whitespace-nowrap md:py-4 py-2 font-medium">
                    {children}
                  </h2>
                ),

                h3: ({ children }: any) => (
                  <h3 className="text-lg md:text-text-2xl whitespace-normal md:py-4 py-2 font-medium">
                    {children}
                  </h3>
                ),

                h4: ({ children }: any) => (
                  <h4 className="text-md py-2 md:text-xl font-medium md:py-8 whitespace-nowrap ">
                    {children}
                  </h4>
                ),
