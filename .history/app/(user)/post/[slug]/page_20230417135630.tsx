      ...
      <article className=" pb-28 flex flex-col justify-center items-center align-middle mx-auto max-w-3xl ">
        ...
        <section>
          <div>
            ...
            {/* Ignore TS */}
            <PortableText
              className="max-w-sm mx-auto  tracking-tighter md:max-w-2xl "
              serializers={{
                normal: ({ children }: any) => (
                  <div className="text-base text-white/70 my-5 text-justify -tracking-tight  break-inside-auto  ">
                    {children}
                  </div>
                ),
                h1: ({ children }: any) => (
                ...
                h3: ({ children }: any) => (
                  <h3 className="text-lg md:text-text-2xl whitespace-normal md:py-8 py-5 font-medium">
                    {children}
                  </h3>
                ),

                h4: ({ children }: any) => (
                  <h4 className="text-md py-5 md:text-xl font-medium md:py-8 whitespace-nowrap ">
                    {children}
                  </h4>
                ),
