          ...
          <div className="my-[2rem] flex flex-col text-lg">
            ...
            <div className="flex flex-row items-center justify-center md:justify-start">
              <div className="mt-4 mx-4  cursor-pointer">
                <a
                  href="#projects"
                  className=" flex flex-row items-center space-x-4 rounded-md border border-transparent bg-[#03efcf] py-3 px-8 text-center  text-[16px] text-black  cursor-pointer"
                >
                  Explore now
                  <ArrowLongDownIcon className="h-4 w-4 animate-pulse" />
                </a>
              </div>
            </div>
