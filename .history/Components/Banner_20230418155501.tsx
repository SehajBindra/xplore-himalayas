      ...
      <div className="col-span-1 md:col-span-2 my-24">
        <div className="top-1/2 text-center">
          <div className="my-[2rem]  flex flex-col text-lg">
            <p className="text-center md:text-center xl:text-left text-white/75 xl:ml-14 text-[20px]">
              Hello, I am{" "}
            </p>
            <span className="my-2 text-[#ed00eb] md:text-center text-[2rem] sm:text-[3rem] md:my-4 md:text-2xl xl:text-[4rem]">
              {pageInfo?.name}
            </span>
