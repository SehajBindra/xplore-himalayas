...
function Header() {
  return (
    <header className="flex max-w-5xl   items-center space-x-2 justify-center sm:justify-between font-medium px-10 py-5">
      <Link href="/">
      ...
      <div>
        <div className="hidden md:inline-flex space-x-4 ml-24  ">
          {NavLinks.map((link) => (
