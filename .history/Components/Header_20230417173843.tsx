  ...
  NavLinks.forEach((link) => {
    link.className =
      link.href === pathname
        ...
        : "sm:px-3 text-center sm:py-2 text-[14px] sm:text-[16px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 text-white/90 duration-300 hover:text-white";
  });
