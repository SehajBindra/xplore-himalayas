...
function Banner({ pageInfo }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 h-[620px] sm:h-[600px] md:h-[650px] lg:h-[700px] xl:h-[700px]">
      {/* left col */}
      <div className="col-span-1 md:col-span-2 my-24">
        <div className="top-1/2 text-center">
          <div className="my-[2rem] flex flex-col text-lg">
            <p className="text-center md:text-left text-white/75 xl:ml-14 text-[20px]">
              Hello, I am{" "}
            </p>
            <span className="my-2 text-[#ed00eb] text-[2rem] sm:text-[3rem] md:my-4 md:text-[4rem]">
              {pageInfo?.name}
            </span>
            <span className="my-2 text-white/75 whitespace-nowrap text-[2rem] text-center md:text-right xl:mr-12 sm:text-lg md:my-[1rem]">
              {pageInfo?.role}
            </span>
            ...
            <div className="flex flex-row items-center justify-center md:justify-start">
              <div className="mt-4  mx-10  cursor-pointer">
                <a
                  href="#projects"
      ...
      <div className="col-span-2 sm:flex flex-col items-center space-x-2 hidden md:inline">
        <img
          className="hidden md:inline shadow-xl md:h-[400px] object-cover h-[600px] w-full"
          src="/final16.png"
        />
      </div>
    </div>
