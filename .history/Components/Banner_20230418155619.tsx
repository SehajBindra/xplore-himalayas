      ...
      <div className="col-span-1 md:col-span-2 my-24">
        <div className="top-1/2 text-center">
          <div className="my-[2rem]  flex flex-col text-lg">
            ...
            <span className="my-2 text-[#ed00eb] md:text-center text-[2rem] sm:text-[3rem] xl:my-4 md:text-2xl xl:text-[4rem]">
              {pageInfo?.name}
            </span>
            <span className="my-2 text-white/75 whitespace-nowrap text-[2rem] text-center md:text-right xl:mr-12 sm:text-lg md:my-[1rem]">
              {pageInfo?.role}
            </span>
            <p className="my-4 flex-col text-justify -tracking-tight text-white/75 max-w-[20rem] mx-auto md:text-center text-sm md:max-w-xl lg:max-w-2xl">
