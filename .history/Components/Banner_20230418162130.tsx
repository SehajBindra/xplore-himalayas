      ...
      <div className="col-span-1 md:col-span-2 my-24">
        <div className="top-1/2 text-center">
          <div className="my-[2rem]   max-w-5xl  flex flex-col text-lg">
            ...
            <span className="my-2 text-[#ed00eb] md:text-center text-[2rem] sm:text-[3rem] lg:my-4 md:text-3xl lg:text-[4rem]">
              {pageInfo?.name}
            </span>
            <span className="my-2 md:my-0 md:mt-1 text-white/75 whitespace-nowrap md:text-3xl text-[2rem] text-center lg:text-right lg:mr-12 sm:text-lg lg:my-[1rem]">
              {pageInfo?.role}
            </span>
            <p className="my-4 mx-auto flex-col text-justify -tracking-tight text-white/75 max-w-[20rem]   text-sm md:max-w-xs lg:max-w-2xl">
